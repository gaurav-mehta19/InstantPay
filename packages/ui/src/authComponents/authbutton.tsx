...
export const SecondaryButton = ({ label, onClick }: ButtonProps) => {
  return (
    <button className="bg-[#0f0f10] text-neutral-200 w-96 h-10 flex justify-center items-center gap-4 rounded-md text-base  border border-neutral-700 hover:bg-neutral-800 font-medium" onClick={onClick}>
