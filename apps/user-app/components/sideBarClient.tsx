...
export function SideBarClient() {
    ...
    return (
        <div className={`transform transition-width duration-150 ease-in-out ${isSideBarOpen ? "w-60" : "w-0"} overflow-hidden  h-screen bg-[#18181a]`}>
            <div>
...
function HomeIcon() {
    return <svg xmlns="http://www.w3.org/2000/svg" fill="" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
